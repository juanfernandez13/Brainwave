...
const Princing = () => {
  return <Section className={"overflow-hidden"} id={"pricing"}>
    <div className="container relative z-2">
      ...
      <div className="flex justify-center mt-10"><a href="/pricing" className="text-xs font-bold font-code tracking-wider uppercase border-b">See the full details</a></div>
    </div>
  </Section>;
};
